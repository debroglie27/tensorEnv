...
my_img1 = PhotoImage(file="../Projects/ImageViewer_App/ImageViewer_Images/car.png")
my_img2 = PhotoImage(file="../Projects/ImageViewer_App/ImageViewer_Images/bike.png")
