...
class HomeScreen:
    ...
    def __init__(self, master, title, geo):
        ...
        self.background_img = ImageTk.PhotoImage(Image.open("FlashCard_Images/background.jpg"))
...
class StatesFrame:
    ...
    def random_state(self, param):
        ...
        state_image_path = './FlashCard_Images/' + self.our_states[self.random_number] + '.png'
...
class StateCapitalsFrame:
    ...
    def random_state_capitals(self, param):
        ...
        state_image_path = './FlashCard_Images/' + self.answer + '.png'
